...
import io.github.grantchen2003.cdb.tx.manager.redis.grpc.*;
...
class TxManagerRedisServiceImplTest {
    ...
    private TxManagerRedisServiceImpl service;
    ...
    void setUp() {
        ...
        service = new TxManagerRedisServiceImpl(chronicleClientMock, writeSchemaMock);
    }
